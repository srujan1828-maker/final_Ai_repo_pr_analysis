import { Job, Review, SourceChecklist } from '@/types';
...
export const mockSourceChecklists: Record<string, SourceChecklist> = {
  'j-a1b2c3d4': {
    job_id: 'j-a1b2c3d4',
    items: [
      { id: 'pr_diff', label: 'PR Diff Retrieved', description: 'The pull request diff has been fetched from GitHub', checked: true },
      { id: 'branch_info', label: 'Branch Identified', description: 'The source and target branches have been resolved', checked: true },
      { id: 'test_results', label: 'Test Results Collected', description: 'Unit and integration test results from the sandbox run', checked: true },
      { id: 'lint_output', label: 'Lint Output Analyzed', description: 'Static analysis and linter output has been reviewed', checked: true },
      { id: 'dep_analysis', label: 'Dependency Check', description: 'New or changed dependencies have been audited', checked: true },
      { id: 'security_scan', label: 'Security Scan Complete', description: 'Automated security vulnerability scanning has been run', checked: true },
    ],
  },
};
